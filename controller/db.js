var DB = (function() {
    ...
    function createTablesIfExist(tx) {
        tx.executeSql('CREATE TABLE IF NOT EXISTS search_history_local (id INTEGER NOT NULL PRIMARY KEY, search_string TEXT, search_time DATE)');
        
        tx.executeSql('CREATE TABLE IF NOT EXISTS solution (id INTEGER NOT NULL PRIMARY KEY, name TEXT not null, description TEXT)');
        ...
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (2, 1, 2, "Suchen von etwas...")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (3, 1, 3, "PseudoCode")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (3, 1, 4, "JavaCode")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (4, 2, 1, "Bubblesort (auch Sortieren durch Aufsteigen) ist ein Algorithmus, der vergleichsbasiert eine Liste von Elementen sortiert. Dieses Sortierverfahren arbeitet in-place, sortiert stabil und hat eine Laufzeit von \mathcal{O}(n^2) im schlimmsten (Worst-Case) wie auch im durchschnittlichen Fall (Average-Case)")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (5, 2, 2, "Suchen von etwas...")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (6, 2, 3, "PseudoCode")');
        tx.executeSql('INSERT INTO solution_detail (id, detail_type_id, solution_id, content) VALUES (7, 2, 4, "JavaCode")');
    }
